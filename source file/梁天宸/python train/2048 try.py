...
class Matrix2048():
    def __init__(self, column: int = 5):
        self.column = column
...
class Window2048():
    ...
    def init_setting(self, column):
        ...
        self.style = {
            ...
            2 ** 26: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 12},
            2 ** 27: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 11},
            2 ** 28: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 10},
            2 ** 29: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 9},
            2 ** 30: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 8},
            2 ** 31: {'bg': '#3a3a3a', 'fg': '#E0E0E0', 'fz': 7},
        }
